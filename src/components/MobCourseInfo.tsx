...
export default function MobCourseInfo() {
            ...
            secondary={
              <React.Fragment>
                <Typography
                  ...
                  color="text.primary"
                >
                  Mobil programlama; bilgisayarları, sunucuları, mobil cihazları, elektronik sistemleri, ağları ve verileri kötü amaçlı saldırılardan koruma uygulamasıdır.
